...
class PygView(object):
    ...
    def paint(self):
        ...
        pygame.draw.line(self.background, (10,10,10), (PygView.width // 2, 0), (PygView.width // 2, PygView.height), 3)
        pygame.draw.circle(self.background, (10,10,10), (PygView.width // 2, PygView.height // 2), 100, 3)
        pygame.draw.circle(self.background, (10,10,10), (0, PygView.height // 2), 200, 1)
        pygame.draw.circle(self.background, (10,10,10), (PygView.width, PygView.height // 2), 200, 1)
        ...
        self.goal1 = Goal(pos=v.Vec2d(25, PygView.height//2), side="left", width=50, height=250, color=(255,0,0))
        self.goal2 = Goal(pos=v.Vec2d(PygView.width - 25, PygView.height//2), side="right", width=50, height=250, color=(0,0,255))
