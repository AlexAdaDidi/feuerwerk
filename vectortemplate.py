...
class PygView(object):
    ...
    def paint(self):
        ...
        self.cannonb = Cannon(pos=v.Vec2d(PygView.width-20,20), color=(255,255,0))
        self.cannonc = Cannon(pos=v.Vec2d(20,PygView.height-20), color=(0,255,0))
        self.cannond = Cannon(pos=v.Vec2d(PygView.width-20,PygView.height-20), color=(0,0,255))
    ...
    def run(self):
        ...
        while running:
            ...
            #vectordiff = self.cannonc.pos - self.ball1.pos
            ...
            #vectordiff = self.cannond.pos - self.ball1.pos
